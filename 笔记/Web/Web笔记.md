...
- 从closed shadow dom的iframe中获取值。据说可以用[performance APIS](https://developer.mozilla.org/en-US/docs/Web/API/Performance_API/Monitoring_bfcache_blocking_reasons),或者跟着wp用[window references](https://github.com/whatwg/html/issues/763)