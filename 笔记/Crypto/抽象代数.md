...
$$H=\{\begin{pmatrix}\alpha &\beta \\ -\beta &\alpha \end{pmatrix}|\alpha,\beta\in \Complex\}$$
...
$$\begin{pmatrix}\alpha \overline{\alpha }+\beta \overline{\beta }&0\\ 0&\alpha \overline{\alpha }+\beta \overline{\beta }\end{pmatrix}$$

=

$$\left(\alpha \overline{\alpha }+\beta \overline{\beta }\right)\begin{pmatrix}1&0\\ 0&1\end{pmatrix}$$
