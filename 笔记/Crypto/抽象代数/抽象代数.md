...
设R为交换幺环，R上秩n的自由模为M， $u_1,u_2,...,u_n$ 为一组基。 $\forall x\in M$ ，x可唯一表示为 $\sum _{i=1}^{n}x_iu_i,x_i\in R$ 。将 $(x_1,x_2,...,x_n)'$ 称为x在 $u_1,u_2,...,u_n$ 下的坐标。记为 $Crd(x_j\space u_1,u_2,...,u_n)=(x_1,x_2,...,x_n)'=\begin{pmatrix}x_1\\ x_2\\ ...\\ x_n\end{pmatrix}$ . $x=(u_1,u_2,...,u_n)\begin{pmatrix}x_1\\ x_2\\ ...\\ x_n\end{pmatrix}=(u_1,u_2,...,u_n)Crd(x)$
